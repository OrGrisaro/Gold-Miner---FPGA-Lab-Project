// module responsible to give a signal every one second that passes
...
parameter logic SIMULATION_MODE = 0 ;// to update in outside table: 1 for simulation, 0 for DE10 board
